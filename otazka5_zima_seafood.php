    ...
    <div class="container">
        <section class="form col-lg-12">
            ...
            <div class="row form--links py-4">
                <a href="https://www.pelikan.sk/sk/multicity/dubaj-mauricius-reunion-seychely" target="_blank" onclick="window.location.href='end.php';" class="col-lg-3 d-flex flex-column mb-4 mb-lg-0">
                ...
                <a href="https://www.pelikan.sk/sk/multicity/dubaj-mauricius-reunion-seychely" target="_blank" onclick="window.location.href='end.php';" class="col-lg-3 d-flex flex-column mb-4 mb-lg-0">
                    <figure class="image-cropper">
                        <img src="assets/images/conversy.png" alt="Tenisky">
                    </figure>
                    <h2 class="text-center">Tenisky</h2>
                </a>
                <a href="https://www.pelikan.sk/sk/multicity/dubaj-mauricius-reunion-seychely" target="_blank" onclick="window.location.href='end.php';" class="col-lg-3 d-flex flex-column mb-4 mb-lg-0">
                    <figure class="image-cropper">
