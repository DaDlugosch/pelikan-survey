    ...
    <div class="container">
        <section class="form col-lg-12">
            ...
            <div class="row form--links py-4">
                <a href="https://www.pelikan.sk/sk/multicity/portugalsko-azory" target="_blank" onclick="window.location.href='end.php';" class="col-lg-3 d-flex flex-column mb-4 mb-lg-0">
